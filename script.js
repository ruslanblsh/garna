const i18n = {
  en: {
    ...
    'fees.caption': 'Early Access creators can receive a reduced 1.5% fee for their first payouts while we help validate and fine-tune the setup flow.',
    'fees.disclaimer': 'Final fee terms may depend on the platform, payout method and individual setup.',
    ...
    'faq.a8': 'The standard fee is 4%. Early Access creators can receive a reduced 1.5% fee for their first payouts, subject to final confirmation and setup details.',

    'final.title': 'Start receiving creator payouts with Garna',
    'final.text': 'Create your Garna account or contact your payout manager to check your platform and get guided setup.',
  ...
  ru: {
    ...
    'transition.title': 'Переносите настройку выплат в Garna?',
    'transition.text': 'Вы попали в Garna через одного из наших партнёров. Наша команда поможет вам шаг за шагом перенести настройку выплат, чтобы вы могли продолжить получать выплаты с меньшим количеством сложностей.',
    ...
    'helps.title': 'Один аккаунт для выплат креаторов',
    ...
    'how.s6.text': 'Garna сопоставит платёж с вашим инвойсом, зачислит баланс, и вы сможете вывести деньги доступным способом.',
    ...
    'fees.caption': 'Early Access креаторы могут получить сниженную комиссию 1.5% на первые выплаты, пока мы помогаем проверять и дорабатывать процесс настройки.',
    'fees.disclaimer': 'Финальные условия комиссии могут зависеть от платформы, способа выплаты и индивидуальной настройки.',
    ...
    'faq.a8': 'Стандартная комиссия — 4%. Early Access креаторы могут получить сниженную комиссию 1.5% на первые выплаты, при условии финального подтверждения и деталей настройки.',

    'final.title': 'Начните получать creator payouts через Garna',
    'final.text': 'Создайте аккаунт Garna или свяжитесь с payout-менеджером, чтобы проверить вашу платформу и получить сопровождение при настройке.',
